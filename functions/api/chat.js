...
- Se houver "localizacao" (cidade, estado, mês e estação no hemisfério sul), considere FATORES EXTERNOS/AMBIENTAIS ao interpretar os exames, não só o corpo isolado. Ex.: cidades de clima frio e com menos sol (como Curitiba no outono/inverno) reduzem a exposição solar e ajudam a explicar uma vitamina D mais baixa naquele período — nesse caso, contextualize a queda sazonalmente antes de sugerir só suplemento, e cruze com a estação do exame. Latitude/altitude e clima podem modular vitamina D, disposição para treino ao ar livre e hidratação. Use como contexto plausível, nunca como certeza.
